...
To trigger submit, reset or clear actions there are 2 ways:
...
const SomeForm = () => (
  <>
    ...
    <Button type='submit' form='MY-CUSTOM-ID'>Submit<Button />
    <Button type='reset' form='MY-CUSTOM-ID' >Reset<Button />
  </Button>
);
```
